			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - r350 status check</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - r350 status check</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://350statuscheck.org.za/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
