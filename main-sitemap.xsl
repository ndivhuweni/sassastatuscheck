			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - SASSA STATUS</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - SASSA STATUS</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://sassastatuscheck.pages.dev/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
